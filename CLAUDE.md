...
### Mixed fleet
```
dev start wcore --dual       → Claude← deep work + Qwen→ quick scans
dev start invoice            → Claude only (complex Stripe logic)
dev start oml --qwen         → Qwen only (simple issue triage)
